                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <span className="inline-flex items-center text-[10px] font-mono font-bold text-slate-700 bg-slate-100 border border-slate-300 px-2 py-0.5">
                          {m.source_journal.split(' ')[0]}
                        </span>
                      </td>
                    </tr>
                  );
